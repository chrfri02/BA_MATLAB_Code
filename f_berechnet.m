...
% Funktion zur Berechnung der Modenfrequenzen einer Metamaterialspule über die Birdcage-Regressionsformel
...
% Berechnung der zu den eingegebenen Parametern gehörigen Koeffizienten
    % Induktivität L
        % absolute Änderungen bezogen auf jeden Parameter
            % Stripeanzahl N
            a_L_N =  -4.0290e-08;
            b_L_N =   1.3133e-07;
            
            L_N = a_L_N*sqrt(1/N)+b_L_N;        % Modell sqrt(1/N)
            Delta_L_N = L_N-L_Standard;         % absolute Änderung von L bezogen auf N abweichend vom Standardwert
            ...
            Delta_L_l = L_l-L_Standard;         % absolute Änderung von L bezogen auf l abweichend vom Standardwert
            ...
            Delta_L_S = L_S-L_Standard;         % absolute Änderung von L bezogen auf l abweichend vom Standardwert
        
        % Endwert für L als Summe des Standardwerts mit den absoluten Änderungen bezogen auf jeden Spulenparameter
        L = L_Standard+Delta_L_N+Delta_L_l+Delta_L_S;   
    
    % Induktivitätsverhältnis alpha
            % Stripeanzahl N
            a_alpha_N = 0.2246;
            b_alpha_N = 0.52;
            c_alpha_N = 0.1619;
            ...
            Delta_alpha_N = alpha_N-alpha_Standard;             % absolute Änderung von alpha bezogen auf N abweichend vom Standardwert
            ...
            Delta_alpha_l = alpha_l-alpha_Standard;     % absolute Änderung von alpha bezogen auf l abweichend vom Standardwert
            ...
            Delta_alpha_S = alpha_S-alpha_Standard;     % absolute Änderung von alpha bezogen auf S abweichend vom Standardwert
    
        % Endwert für alpha als Summe des Standardwerts mit den absoluten Änderungen bezogen auf jeden Spulenparameter
    ...
    % Koppelkonstante k
            ...
            Delta_k_N = k_N-k_Standard;                 % absolute Änderung von k bezogen auf N abweichend vom Standardwert
            ...
            Delta_k_l = k_l-k_Standard;                 % absolute Änderung von k bezogen auf l abweichend vom Standardwert
            ...
            Delta_k_S = k_S-k_Standard;                  % absolute Änderung von k bezogen auf S abweichend vom Standardwert
...
Omega_con = linspace(1,N-1);      % Modennummer Omega, kontinuierlich für den Graphen
Omega_dis = 1:N-1;                % Modennummer Omega, diskret für die Moden-Frequenzen
